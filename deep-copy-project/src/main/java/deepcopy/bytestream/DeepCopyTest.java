...
import deepcopy.bytestream.impl.AddressImpl;
import deepcopy.bytestream.impl.CruisePackageImpl;
import deepcopy.bytestream.impl.NameImpl;
import deepcopy.bytestream.impl.ReservationImpl;
import deepcopy.bytestream.impl.StopImpl;
import deepcopy.bytestream.impl.UserImpl;
...
public class DeepCopyTest {
	...
	public void test() {
		...
		for (Reservation r : reservations) {
			reservations2.add(ReservationImpl.deepClone(r));
		}
